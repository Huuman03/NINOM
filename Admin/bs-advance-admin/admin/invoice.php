        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-md-12">
                       ...
                       <?php
                            ...
                            $select_product=$get_data->selecthd();
                            ?>
            ...
            foreach ($select_product as $i_dk)
            {
                ...
                <tr class="k2">
                    ...
                    <td><img src="upload/<?php echo $i_dk['anh'] ?>" alt="" width="100px" height="50px"></td>

                    <td><?php 
                    $string=strval($i_dk['tongtien']);
                    ...
                    <td><a href="huy.php?huy=<?php echo $i_dk['id_don']?>" class="btn btn-danger"
                        onclick="if(confirm('Bạn có chắc muốn huỷ đơn này'))return true;
                        else return false";> Huỷ </td></td>

                    <td><a href="duyet.php?duyet=<?php echo $i_dk['id_don']?>&&sl=<?php echo $i_dk['soluong'] ?>" class="btn btn-info"
                    onclick="if(confirm('Bạn có chắc muốn duyệt đơn này ( sẽ trừ đi số lượng trong kho ).'))return true;
                    else return false";> Duyệt </td>
                </tr> 
                <?php
            }
        }
